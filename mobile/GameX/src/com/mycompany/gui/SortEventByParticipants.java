 ...
 * @author WIKI
 */
public class SortEventByParticipants extends Form{
      ArrayList<Evenement> data = new ArrayList<>();
    Form current;

    public SortEventByParticipants(Form previous) {
    setTitle("Sort by participants");
     Picker datePicker = new Picker();

    data=EvenementService.getInstance().SortByPart();
