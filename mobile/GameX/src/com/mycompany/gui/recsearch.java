...
public class recsearch extends Form {
    Form current;
    public  recsearch(Form previous,Reclamation rec) {
        current = this;
        ...
        add(trie);
                       ...
                       // for(Reclamation p : listerec)
                        //{
                            ...
                            m.setTextLine1(""+rec.getTitle());
                            m.setTextLine2(""+rec.getDescription());
                             ...
                             m.addPointerReleasedListener(new ActionListener() {
                                    ...
                                    public void actionPerformed(ActionEvent evt) {
                                        if (Dialog.show("Confirmation", "Que voulez vous faire ?", "Supprimer", "Modifier")) {
                                                ...
                                                if( ReclamationService.getInstance().delReclamation(rec)){
                                                    {
                                                       Dialog.show("Success","La réclamation "+rec.getTitle()+" a été supprimé avec succées",new Command("OK"));
                                                       previous.showBack();
                                                    }
                                        }
                                    }
                                                 ...
                                                 EditReclamation t = new EditReclamation(current,rec);
                                                 t.show();
                                        }
                                    }
                                });
