...
public class EditProductForm extends Form{
    ...
    public EditProductForm(Form previous,Product t) {
        /*
        Le paramètre previous définit l'interface(Form) précédente.
        Quelque soit l'interface faisant appel à AddAgence, on peut y revenir
        en utilisant le bouton back
        */
        setTitle("Edit product "+t.getProductName()+"");
        ...
        TextField tfNom= new TextField(t.getProductName());
        TextField tfDescription = new TextField(t.getDescription());
        TextField tfPrix = new TextField("254");
...
logos.addActionListener((ActionEvent e) -> {
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    ...
                    t.setProductName(tfNom.getText());
                    t.setDescription(tfDescription.getText());
                    t.setPrice(prix);
                   
                    if(ServiceProduct.getInstance().editProduct(t)){
                        iDialog.dispose();
                        Dialog.show("Success","product modifié",new Command("OK"));
                        previous.showBack();}
                    else{
                        iDialog.dispose();
        ...
        addAll(logos,tfNom,tfDescription,tfPrix,btnValider);
