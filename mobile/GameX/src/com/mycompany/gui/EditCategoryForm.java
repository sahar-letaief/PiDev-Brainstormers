...
public class EditCategoryForm extends Form{
    ...
    public EditCategoryForm(Form previous,Category t) {
        ...
        */
        ...
        Button logos= new Button("Edit");
        TextField tfNom= new TextField(t.getName());
...
logos.addActionListener((ActionEvent e) -> {
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    ...
                    t.setName(tfNom.getText());
                    t.setDescription(tfDescription.getText());
                    
                   
                    if(ServiceCategory.getInstance().editCategory(t)){
                        iDialog.dispose();
        ...
        addAll(logos,tfNom,tfDescription,btnValider);
