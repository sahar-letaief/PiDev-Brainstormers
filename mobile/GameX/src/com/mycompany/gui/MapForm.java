...
public MapForm(Form previous) {
    ...
    try{
        ...
        cnt.setCameraPosition(new Coord(36.898277, 10.1245125 ));
    }catch(Exception ex) {
        ex.printStackTrace();
    }

        Button btnMoveCamera = new Button("Show my exhibition");
...
f.show();
  f.getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ADD_TO_HOME_SCREEN, e->new ListEventsFormFront(previous).show());
