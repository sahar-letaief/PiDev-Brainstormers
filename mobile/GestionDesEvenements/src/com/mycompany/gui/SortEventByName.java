 ...
 * @author WIKI
 */
public class SortEventByName extends Form {
      ArrayList<Evenement> data = new ArrayList<>();
    Form current;

    public SortEventByName(Form previous) {
    setTitle("Sort by name");
     Picker datePicker = new Picker();

    data=EvenementService.getInstance().SortByName();
     Container y = new Container(new BoxLayout(BoxLayout.Y_AXIS));
      Container yy = new Container(new BoxLayout(BoxLayout.Y_AXIS));
       ...
       public void actionPerformed(ActionEvent evt) {
        ...
        fin.addAll(DateFin);
        xxx.addAll(DeleteEvent,EditEvent);
       // map.addAll(EventMap);
